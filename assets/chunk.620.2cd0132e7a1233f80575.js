(globalThis.webpackChunk_ember_auto_import_=globalThis.webpackChunk_ember_auto_import_||[]).push([[620],{65:(e,t,i)=>{"use strict"
i.d(t,{P:()=>o,q:()=>a})
...
i.d(t,{C:()=>Ve,S:()=>Fe,f:()=>A,h:()=>m,i:()=>S,l:()=>pe,m:()=>Ae,p:()=>K,q:()=>Z,r:()=>Y,s:()=>X,t:()=>Q,u:()=>W,v:()=>_,w:()=>Ke})
var r=i(603),s=i(648),n=i(65),o=i(375),a=i(223),l=i(146)
Symbol("record-originated-on-client"),Symbol("identifier-bucket"),Symbol("warpDriveStaleCache")
const c="__$co"
var d=i(241),h=i(738),u=i(193),f=i(471)
function p(e,t,i){return(t=function(e){var t=function(e){if("object"!=typeof e||!e)return e
var t=e[Symbol.toPrimitive]
if(void 0!==t){var i=t.call(e,"string")
if("object"!=typeof i)return i
throw new TypeError("@@toPrimitive must return a primitive value.")}return String(e)}(e)
return"symbol"==typeof t?t:t+""}(t))in e?Object.defineProperty(e,t,{value:i,enumerable:!0,configurable:!0,writable:!0}):e[t]=i,e}function y(e,t,i){if("function"==typeof e?e===t:e.has(t))return arguments.length<3?t:i
throw new TypeError("Private element is not present on this object")}function m(e){{let t
return t=null==e||""===e?null:String(e),(0,r.deprecate)(`The resource id '<${typeof e}> ${String(e)} ' is not normalized. Update your application code to use '${JSON.stringify(t)}' instead.`,t===e,{id:"ember-data:deprecate-non-strict-id",until:"6.0",for:"ember-data",since:{available:"4.13",enabled:"5.3"}}),t}}function g(e){let t=null
return"string"==typeof e?t=e.length>0?e:null:"number"!=typeof e||isNaN(e)||(t=String(e)),t}function _(e){{const t=(0,d._k)(e)
return(0,r.deprecate)(`The resource type '${e}' is not normalized. Update your application code to use '${t}' instead of '${e}'.`,t===e,{id:"ember-data:deprecate-non-strict-types",until:"6.0",for:"ember-data",since:{available:"4.13",enabled:"5.3"}}),t}}function b(e){return Boolean(e&&"object"==typeof e)}function v(e,t){return Boolean(b(e)&&t in e&&"string"==typeof e[t]&&e[t].length)}function w(e){return v(e,"lid")}function k(e){return v(e,"id")||Boolean(b(e)&&"id"in e&&"number"==typeof e.id)}const R=(0,o.L1)("DOCUMENTS",new Set)
function S(e){return void 0!==e[c]}function A(e){return R.has(e)}const M="undefined"!=typeof FastBoot?FastBoot.require("crypto"):globalThis.crypto,C=new Map
let E=0
function T(e,t,i){"record"===i&&!e.id&&k(t)&&function(e,t,i){let r=e.get(t.type)
r||(r=new Map,e.set(t.type,r)),r.set(i,t.lid)}(C,e,t.id)}function O(e,t){const i=k(e)?m(e.id):null
return{type:function(e){return v(e,"type")}(e)?_(e.type):t?t.type:null,id:i}}function q(e,t){if("record"===t){if(w(e))return e.lid
if(k(e)){const t=_(e.type),i=C.get(t)?.get(e.id)
return i||`@lid:${t}-${e.id}`}return M.randomUUID()}if("document"===t)return e.url?e.method&&"GET"!==e.method.toUpperCase()?null:e.url:null}function D(...e){}function j(e,t,i){return e}class P{constructor(){this._generate=(0,o.Yj)("configuredGenerationMethod")||q,this._update=(0,o.Yj)("configuredUpdateMethod")||T,this._forget=(0,o.Yj)("configuredForgetMethod")||D,this._reset=(0,o.Yj)("configuredResetMethod")||D,this._merge=j,this._keyInfoForResource=(0,o.Yj)("configuredKeyInfoMethod")||O,this._id=E++,this._cache={resources:new Map,resourcesByType:Object.create(null),documents:new Map,polymorphicLidBackMap:new Map}}__configureMerge(e){this._merge=e||j}upgradeIdentifier(e){return this._getRecordIdentifier(e,2)}_getRecordIdentifier(e,t){if(S(e))return e
const i=this._generate(e,"record")
let r=N(this._cache,i)
if(null!==r)return r
if(0!==t){if(2===t)e.lid=i,e[c]=this._id,r=x(e)
else{const t=this._keyInfoForResource(e,null)
t.lid=i,t[c]=this._id,r=x(t)}return F(this._cache,r),r}}peekRecordIdentifier(e){return this._getRecordIdentifier(e,0)}getOrCreateDocumentIdentifier(e){let t=e.cacheOptions?.key
if(t||(t=this._generate(e,"document")),!t)return null
let i=this._cache.documents.get(t)
return void 0===i&&(i={lid:t},R.add(i),this._cache.documents.set(t,i)),i}getOrCreateRecordIdentifier(e){return this._getRecordIdentifier(e,1)}createIdentifierForNewRecord(e){const t=this._generate(e,"record"),i=x({id:e.id||null,type:e.type,lid:t,[c]:this._id})
...
if(null!==n&&n===s&&i===o&&w(r)&&r.lid!==a)return N(e,r.lid)||!1
if(null!==n&&n===s&&i&&i!==o&&w(r)&&r.lid===a){const t=e.resourcesByType[i],r=t&&t.id.get(s)
...
i=this._mergeRecordIdentifiers(r,e,s,t),n&&(t.lid=i.lid)}const o=i.id;(function(e,t,i,r){r(e,i,"record"),void 0!==i.id&&(e.id=m(i.id))})(i,0,t,this._update)
const a=i.id
...
r&&(r.forEach((e=>{this._cache.resources.delete(e)})),this._cache.polymorphicLidBackMap.delete(t.lid)),t[c]=void 0,this._forget(t,"record")}destroy(){C.clear(),this._cache.documents.forEach((e=>{R.delete(e)})),this._reset()}}function x(e,t,i){return e}function N(e,t,i){return e.resources.get(t)||null}function F(e,t){e.resources.set(t.lid,t)
let i=e.resourcesByType[t.type]
i||(i={lid:new Map,id:new Map},e.resourcesByType[t.type]=i),i.lid.set(t.lid,t),t.id&&i.id.set(t.id,t)}function I(e){return"string"==typeof e?e:e.href}var $=new WeakSet
class z{constructor(e,t,i){var r;(function(e,t){if(t.has(e))throw new TypeError("Cannot initialize the same private elements twice on an object")})(this,r=$),r.add(this),this._store=e,this._localCache=i,this.identifier=t,t&&e.notifications.subscribe(t,((e,t)=>{"updated"===t&&((0,l.eM)(this,"data"),(0,l.eM)(this,"links"),(0,l.eM)(this,"meta"),(0,l.eM)(this,"errors"))}))}fetch(e={}){return e.cacheOptions=e.cacheOptions||{},e.cacheOptions.key=this.identifier?.lid,y($,this,L).call(this,this.links.related?"related":"self",e)}next(e={}){return y($,this,L).call(this,"next",e)}prev(e={}){return y($,this,L).call(this,"prev",e)}first(e={}){return y($,this,L).call(this,"first",e)}last(e={}){return y($,this,L).call(this,"last",e)}toJSON(){const e={}
return e.identifier=this.identifier,void 0!==this.data&&(e.data=this.data),void 0!==this.links&&(e.links=this.links),void 0!==this.errors&&(e.errors=this.errors),void 0!==this.meta&&(e.meta=this.meta),e}}async function L(e,t){const i=this.links?.[e]
return i?(t.method=t.method||"GET",Object.assign(t,{url:I(i)}),(await this._store.request(t)).content):null}(0,l.Ly)(z.prototype,"errors",{get(){const{identifier:e}=this
if(!e){const{document:e}=this._localCache
return"errors"in e?e.errors:void 0}const t=this._store.cache.peek(e)
return"errors"in t?t.errors:void 0}}),(0,l.Ly)(z.prototype,"data",{get(){const{identifier:e,_localCache:t}=this,i=e?this._store.cache.peek(e):t.document,r="data"in i?i.data:void 0
return Array.isArray(r)?this._store.recordArrayManager.getCollection({type:e?e.lid:t.request.url,identifiers:r.slice(),doc:e?void 0:i,identifier:e??null}):r?this._store.peekRecord(r):r}}),(0,l.Ly)(z.prototype,"links",{get(){const{identifier:e}=this
return e?this._store.cache.peek(e).links:this._localCache.document.links}}),(0,l.Ly)(z.prototype,"meta",{get(){const{identifier:e}=this
return e?this._store.cache.peek(e).meta:this._localCache.document.meta}})
class B{constructor(e,t){p(this,"___token",void 0),p(this,"___identifier",void 0),this.store=e,this.___identifier=t,this.___token=e.notifications.subscribe(t,((e,t,i)=>{("identity"===t||"attributes"===t&&"id"===i)&&this._ref++}))}destroy(){this.store.notifications.unsubscribe(this.___token)}get type(){return this.identifier().type}id(){return this._ref,this.___identifier.id}identifier(){return this.___identifier}remoteType(){return"identity"}push(e){return Promise.resolve(e).then((e=>this.store.push(e)))}value(){return this.store.peekRecord(this.___identifier)}load(){const e=this.id()
...
function W(e,t){V.set(e,t)}function H(e){V.delete(e)}function K(e){return V.has(e)?V.get(e):null}const J=(0,o.L1)("RecordCache",new Map)
function G(e){return J.get(e)}function Y(e){return J.get(e)}function Z(e,t){J.set(e,t)}const Q=(0,o.L1)("StoreMap",new Map)
function X(e){return Q.get(e)}class ee{constructor(e){this.store=e,this.__instances={record:new Map,reference:new WeakMap,document:new Map},this._storeWrapper=new U(this.store),e.identifierCache.__configureMerge(((e,t,i)=>{let r=e
...
return t||(t=new z(this.store,e,null),this.__instances.document.set(e,t)),t}getRecord(e,t){let i=this.__instances.record.get(e)
if(!i){const r=this.store.cache
W(e,r),i=this.store.instantiateRecord(e,t||{}),Z(i,e),W(i,r),Q.set(i,this.store),this.__instances.record.set(e,i)}return i}getReference(e){const t=this.__instances.reference
let i=t.get(e)
return i||(i=new B(this.store,e),t.set(e,i)),i}recordIsLoaded(e,t=!1){const i=this.cache
if(!i)return!1
const r=i.isNew(e),s=i.isEmpty(e)
return r?!i.isDeleted(e):!(t&&i.isDeletionCommitted(e)||s)}disconnect(e){this.__instances.record.get(e),this.store._graph?.remove(e),this.store.identifierCache.forgetRecordIdentifier(e),H(e),this.store._requestCache._clearEntries(e)}unloadRecord(e){this.store._join((()=>{const t=this.__instances.record.get(e),i=this.cache
t&&(this.store.teardownRecord(t),this.__instances.record.delete(e),Q.delete(t),J.delete(t),H(t)),i?(i.unloadRecord(e),H(e)):this.disconnect(e),this.store._requestCache._clearEntries(e)}))}clear(e){const t=this.store.identifierCache._cache
...
s&&e.call(t,r,s)}}))}}function se(e){return"added"===e||"state"===e||"updated"===e||"removed"===e||"invalidated"===e}function ne(){return!!a._backburner.currentInstance&&!0!==a._backburner._autorun}class oe{constructor(e){this.store=e,this.isDestroyed=!1,this._buffered=new Map,this._hasFlush=!1,this._cache=new Map}subscribe(e,t){let i=this._cache.get(e)
...
const s=r.indexOf(e)
if(-1===s)return
r.splice(s,1)}}(e,this._cache)}notify(e,t,i){if(!S(e)&&!A(e))return!1
...
e.size&&(this._buffered=new Map,e.forEach(((e,t)=>{e.forEach((e=>{this._flushNotification(t,e[0],e[1])}))}))),this._hasFlush=!1,this._onFlushCB?.(),this._onFlushCB=void 0}_flushNotification(e,t,i){if(se(t)){const i=this._cache.get(A(e)?"document":"resource")
i&&i.forEach((i=>{i(e,t)}))}const r=this._cache.get(e)
return!(!r||!r.length||(r.forEach((r=>{r(e,t,i)})),0))}destroy(){this.isDestroyed=!0,this._cache.clear()}}const ae=Proxy,le=new Set([Symbol.iterator,"concat","entries","every","fill","filter","find","findIndex","flat","flatMap","forEach","includes","indexOf","join","keys","lastIndexOf","map","reduce","reduceRight","slice","some","values"]),ce=new Set(["push","pop","unshift","shift","splice","sort"]),de=new Set(["[]","length","links","meta"])
function he(e){return le.has(e)}function ue(e,t){return t in e}const fe=(0,o.L1)("#signal",Symbol("#signal")),pe=(0,o.L1)("#source",Symbol("#source")),ye=(0,o.L1)("#update",Symbol("#update")),me=(0,o.L1)("#notify",Symbol("#notify")),ge=(0,o.L1)("IS_COLLECTION",Symbol.for("Collection"))
function _e(e){(0,l.RH)(e[fe])}function be(e){if("symbol"==typeof e)return null
const t=Number(e)
return isNaN(t)?null:t%1==0?t:null}class ve{[me](){_e(this)}destroy(e){this.isDestroying=!e,this[pe].length=0,this[me](),this.isDestroyed=!e}get length(){return this[pe].length}set length(e){this[pe].length=e}constructor(e){p(this,"isLoaded",!0),p(this,"isDestroying",!1),p(this,"isDestroyed",!1),p(this,"_updatingPromise",null),p(this,"identifier",void 0),p(this,ge,!0),p(this,pe,void 0)
const t=this
this.modelName=e.type,this.store=e.store,this._manager=e.manager,this.identifier=e.identifier||null,this[pe]=e.identifiers,this[fe]=(0,l.n5)(this,"length")
const i=e.store,r=new Map,s=this[fe],n={links:e.links||null,meta:e.meta||null}
let o=!1
const a=new ae(this[pe],{get(a,c,d){const h=be(c)
if(s.shouldReset&&(null!==h||de.has(c)||he(c))&&(e.manager._syncArray(d),s.t=!1,s.shouldReset=!1),null!==h){const e=a[h]
...
return o=!1,e},r.set(c,e)),e}if(function(e){return ce.has(e)}(c)){let i=r.get(c)
return void 0===i&&(i=function(){if(!e.allowMutation)return
const i=Array.prototype.slice.call(arguments)
o=!0
const r=t[ye](a,d,c,i,s)
return o=!1,r},r.set(c,i)),i}if(ue(t,c)){if(c===me||c===fe||c===pe)return t[c]
let e=r.get(c)
if(e)return e
const i=t[c]
return"function"==typeof i?(e=function(){return(0,l.B1)(s),Reflect.apply(i,d,arguments)},r.set(c,e),e):((0,l.B1)(s),i)}return a[c]},set(i,r,a,l){if("length"===r){if(!o&&0===a)return o=!0,t[ye](i,l,"length 0",[],s),o=!1,!0
if(o)return Reflect.set(i,r,a)}if("links"===r)return n.links=a||null,!0
if("meta"===r)return n.meta=a||null,!0
const c=be(r)
if(null===c||c>i.length){if(null!==c&&o){const e=Y(a)
return i[c]=e,!0}return!!ue(t,r)&&(t[r]=a,!0)}if(!e.allowMutation)return!1
const d=i[c],h=(u=a)?Y(u):null
var u
return o?i[c]=h:t[ye](i,l,"replace cell",[c,d,h],s),!0},deleteProperty:(e,t)=>!!o&&Reflect.deleteProperty(e,t),getPrototypeOf:()=>Array.prototype})
return(0,l.zs)(a,s),this[me]=this[me].bind(a),a}update(){if(this.isUpdating)return this._updatingPromise
this.isUpdating=!0
...
const we={enumerable:!0,configurable:!1,get:function(){return this}};(0,h.Vv)(we),Object.defineProperty(ve.prototype,"[]",we),(0,l.sg)(ve.prototype,"isUpdating",!1)
class ke extends ve{constructor(e){super(e),p(this,"query",null),this.query=e.query||null,this.isLoaded=e.isLoaded||!1}_update(){const{store:e,query:t}=this
...
const Re=(0,o.L1)("FAKE_ARR",{}),Se=1200
function Ae(e,t){let i=0
const r=t.length
for(;r-i>Se;)e.push.apply(e,t.slice(i,i+Se)),i+=Se
e.push.apply(e,t.slice(i))}class Me{constructor(e){this.store=e.store,this.isDestroying=!1,this.isDestroyed=!1,this._live=new Map,this._managed=new Set,this._pending=new Map,this._staged=new Map,this._keyedArrays=new Map,this._identifiers=new Map,this._set=new Map,this._visibilitySet=new Map,this._subscription=this.store.notifications.subscribe("document",((e,t)=>{if("updated"===t&&this._keyedArrays.has(e.lid)){const t=this._keyedArrays.get(e.lid)
...
if((i||t)&&!this.isDestroying&&!this.isDestroyed&&(t&&(function(e,t,i){const r=e[pe],s=[],n=[]
t.forEach(((e,t)=>{if("add"===e){if(i.has(t))return
s.push(t),i.add(t)}else i.has(t)&&(n.push(t),i.delete(t))})),n.length&&(n.length===r.length?r.length=0:n.forEach((e=>{const t=r.indexOf(e);-1!==t&&(r.splice(t,1),i.delete(e))}))),s.length&&Ae(r,s)}(e,t,this._set.get(e)),this._pending.delete(e)),i)){const t=e[fe]
...
return r&&(r.forEach(((e,t)=>{"add"===e&&i.push(t)})),this._staged.delete(e)),t||(t=new ve({type:e,identifiers:i,store:this.store,allowMutation:!1,manager:this}),this._live.set(e,t),this._set.set(t,new Set(i))),t}getCollection(e){if(e.identifier&&this._keyedArrays.has(e.identifier.lid))return this._keyedArrays.get(e.identifier.lid)
const t={type:e.type,identifier:e.identifier||null,links:e.doc?.links||null,meta:e.doc?.meta||null,query:e.query||null,identifiers:e.identifiers||[],isLoaded:!!e.identifiers?.length,allowMutation:!1,store:this.store,manager:this},i=new ke(t)
return this._managed.add(i),this._set.set(i,new Set(t.identifiers||[])),e.identifier&&this._keyedArrays.set(e.identifier.lid,i),e.identifiers&&Ce(this._identifiers,i,e.identifiers),i}dirtyArray(e,t,i){if(e===Re)return
const r=e[fe]
i&&(r.reason="cache-sync"),r.shouldReset?t>0&&!r.t&&(0,l.Fe)(e[me]):(r.shouldReset=!0,(0,l.Fe)(e[me]))}_getPendingFor(e,t,i){if(this.isDestroying||this.isDestroyed)return
const r=this._live.get(e.type),s=this._pending,n=new Map
if(t){const t=this._identifiers.get(e)
t&&t.forEach((e=>{let t=s.get(e)
t||(t=new Map,s.set(e,t)),n.set(e,t)}))}if(r&&0===r[pe].length&&i){const e=s.get(r)
...
const r=e[pe],s=r.slice()
r.length=0,Ae(r,t),this._set.set(e,new Set(t)),_e(e),e.meta=i?.meta||null,e.links=i?.links||null,e.isLoaded=!0,function(e,t,i){for(let r=0;r<i.length;r++)Ee(e,t,i[r])}(this._identifiers,e,s),Ce(this._identifiers,e,t)}identifierAdded(e){const t=this._getPendingFor(e,!1)
...
this._visibilitySet.get(e)!==t&&(t?this.identifierAdded(e):this.identifierRemoved(e))}clear(e=!0){this._live.forEach((t=>t.destroy(e))),this._managed.forEach((t=>t.destroy(e))),this._managed.clear(),this._identifiers.clear(),this._pending.clear(),this._set.forEach((e=>e.clear())),this._visibilitySet.clear()}destroy(){this.isDestroying=!0,this.clear(!1),this._live.clear(),this.isDestroyed=!0,this.store.notifications.unsubscribe(this._subscription)}}function Ce(e,t,i){for(let r=0;r<i.length;r++){const s=i[r]
let n=e.get(s)
n||(n=new Set,e.set(s,n)),n.add(t)}}function Ee(e,t,i){const r=e.get(i)
r&&r.delete(t)}const Te=(0,o.L1)("Touching",Symbol("touching")),Oe=(0,o.L1)("RequestPromise",Symbol("promise")),qe=[]
class De{constructor(e){p(this,"_pending",new Map),p(this,"_done",new Map),p(this,"_subscriptions",new Map),p(this,"_toFlush",[]),p(this,"_store",void 0),this._store=e}_clearEntries(e){this._done.delete(e)}_enqueue(e,t){const i=t.data[0]
...
return n[Te]=[i.recordIdentifier],n[Oe]=e,this._pending.get(r).push(n),this._triggerSubscriptions(n),e.then((e=>{this._dequeue(r,n)
const i={state:"fulfilled",request:t,type:s,response:{data:e}}
return i[Te]=n[Te],this._addDone(i),this._triggerSubscriptions(i),e}),(e=>{this._dequeue(r,n)
const i={state:"rejected",request:t,type:s,response:{data:e}}
throw i[Te]=n[Te],this._addDone(i),this._triggerSubscriptions(i),e}))}}_triggerSubscriptions(e){"pending"!==e.state?(this._toFlush.push(e),1===this._toFlush.length&&this._store.notifications._onNextFlush((()=>{this._flush()}))):this._flushRequest(e)}_flush(){this._toFlush.forEach((e=>{this._flushRequest(e)})),this._toFlush=[]}_flushRequest(e){e[Te].forEach((t=>{const i=this._subscriptions.get(t)
i&&i.forEach((t=>t(e)))}))}_dequeue(e,t){const i=this._pending.get(e)
this._pending.set(e,i.filter((e=>e!==t)))}_addDone(e){e[Te].forEach((t=>{const i=e.request.data[0].op
...
i||(i=[],this._subscriptions.set(e,i)),i.push(t)}getPendingRequestsForRecord(e){return this._pending.get(e)||qe}getLastRequestForRecord(e){const t=this._done.get(e)
return t?t[t.length-1]:null}}function je(e){return Boolean(e&&"string"==typeof e)}function Pe(e,t,i){if("object"==typeof e&&null!==e){const t=e
return S(t)||"id"in t&&(t.id=m(t.id)),t}{const r=m(t)
if(!je(r)){if(je(i))return{lid:i}
throw new Error("Expected either id or lid to be a valid string")}return je(i)?{type:e,id:r,lid:i}:{type:e,id:r}}}globalThis.setWarpDriveLogging=n.q,globalThis.getWarpDriveRuntimeConfig=n.P
const xe=(0,u.A)(f),Ne=xe.default?xe.default:xe
Ne!==class{constructor(e){}}&&(0,r.deprecate)("The Store class extending from EmberObject is deprecated.\nPlease remove usage of EmberObject APIs and mark your class as not requiring it.\n\nTo mark the class as no longer extending from EmberObject, in ember-cli-build.js\nset the following config:\n\n```js\nconst app = new EmberApp(defaults, {\n  emberData: {\n    deprecations: {\n      DEPRECATE_STORE_EXTENDS_EMBER_OBJECT: false\n    }\n  }\n});\n```\n",!1,{id:"ember-data:deprecate-store-extends-ember-object",until:"6.0",for:"ember-data",url:"https://deprecations.emberjs.com/id/ember-data-deprecate-store-extends-ember-object",since:{available:"4.13",enabled:"5.4"}})
class Fe extends Ne{get schema(){return this._schema||(this._schema=this.createSchemaService()),this._schema}get isDestroying(){return this._isDestroying}set isDestroying(e){this._isDestroying=e}get isDestroyed(){return this._isDestroyed}set isDestroyed(e){this._isDestroyed=e}constructor(e){super(e),Object.assign(this,e),this.identifierCache=new P,this.notifications=new oe(this),this.recordArrayManager=new Me({store:this}),this._requestCache=new De(this),this._instanceCache=new ee(this),this.isDestroying=!1,this.isDestroyed=!1}_run(e){const t=this._cbs={}
...
return this._join((()=>{const r=_(e),s={...t}
let n=null
if(null===s.id||void 0===s.id){const e=this.adapterFor?.(r,!0)
n=e&&e.generateIdForRecord?s.id=m(e.generateIdForRecord(this,r,s)):s.id=null}else n=s.id=m(s.id)
const o={type:r,id:n}
...
n&&("hasMany"===n.kind?i[r]=i[r].map((e=>$e(e))):"belongsTo"===n.kind&&(i[r]=$e(i[r])))}}}return i}(this,a,s),d=l.clientDidCreate(a,c)
...
t&&this._instanceCache.unloadRecord(t)}findRecord(e,t,i){Ie(e)?i=t:e=Pe(_(e),g(t))
...
i=1===arguments.length&&Ie(e)?e:Pe(_(e),g(t))
const r=this.identifierCache.getOrCreateRecordIdentifier(i)
return this._instanceCache.getReference(r)}peekRecord(e,t){if(1===arguments.length&&Ie(e)){const t=this.identifierCache.peekRecordIdentifier(e)
return t&&this._instanceCache.recordIsLoaded(t)?this._instanceCache.getRecord(t):null}const i={type:_(e),id:g(t)},r=this.identifierCache.peekRecordIdentifier(i)
return r&&this._instanceCache.recordIsLoaded(r)?this._instanceCache.getRecord(r):null}query(e,t,i={}){return this.request({op:"query",data:{type:_(e),query:t,options:i},cacheOptions:{[s.ER]:!0}}).then((e=>e.content))}queryRecord(e,t,i){return this.request({op:"queryRecord",data:{type:_(e),query:t,options:i||{}},cacheOptions:{[s.ER]:!0}}).then((e=>e.content))}findAll(e,t={}){return this.request({op:"findAll",data:{type:_(e),options:t||{}},cacheOptions:{[s.ER]:!0}}).then((e=>e.content))}peekAll(e){return this.recordArrayManager.liveArrayFor(_(e))}unloadAll(e){this._join((()=>{void 0===e?(this._graph?.identifiers.clear(),this.recordArrayManager.clear(),this._instanceCache.clear()):this._instanceCache.clear(_(e))}))}push(e){const t=this._push(e,!1)
...
if(e.setResponse(a.response),"error"in a){const t=l?We(i,e.request,{shouldHydrate:l,identifier:r},a.content):a.content,s=Be(a)
throw s.content=t,s}return l?We(i,e.request,{shouldHydrate:l,identifier:r},a.content):a.content}}
function We(e,t,i,r){const{identifier:s}=i
return r&&i.shouldHydrate?s?e._instanceCache.getDocument(s):new z(e,null,{request:t,document:r}):r}function He(e,t,i,r){const{store:n}=t.request,o={shouldHydrate:t.request[s._q]||!1,identifier:i,priority:r}
let a=!1
if(Le(t.request)){a=!0
...
return We(e,t,i,s)}(e,s,i,r)})),e._enableAsyncFlush=null,e.lifetimes?.didRequest&&e.lifetimes.didRequest(t.request,r.response,i.identifier,e),Ue(i.identifier,e.requestManager._deduped,i.priority).blocking)return n
...
if(!Le(t.request))return s=e.cache.put(r),We(e,t.request,i,s)
...
if(Ue(i.identifier,e.requestManager._deduped,i.priority).blocking){const e=Be(r)
throw e.content=s,e}e.notifications._flush()}(n,t,o,e)))
if(!a)return l
const c=t.request.data?.record||t.request.records?.[0]
return n._requestCache._enqueue(l,{data:[{op:"saveRecord",recordIdentifier:c,options:void 0}]})}class Ke extends ve{constructor(e){super(e),this.isLoaded=e.isLoaded||!1,this.isAsync=e.isAsync||!1,this.isPolymorphic=e.isPolymorphic||!1,this.identifier=e.identifier,this.key=e.key}[ye](e,t,i,r,s){switch(i){case"length 0":return Reflect.set(e,"length",0),Xe(this,[],s),!0
case"replace cell":{const[t,i,n]=r
return e[t]=n,function(e,t,i){et(e,{op:"replaceRelatedRecord",record:e.identifier,field:e.key,...t},i)}(this,{value:n,prior:i,index:t},s),!0}case"push":{const n=Je(r)
Ye(this,e,(e=>e.push(...n)),"Cannot push duplicates to a hasMany's state.")
{const n=new Set(e),o=new Set
r.forEach((e=>{const t=Y(e)
n.has(t)||(n.add(t),o.add(e))}))
const a=Array.from(o),l=Reflect.apply(e[i],t,a)
return a.length&&Ze(this,{value:Je(a)},s),l}}case"pop":{const n=Reflect.apply(e[i],t,r)
return n&&Qe(this,{value:Y(n)},s),n}case"unshift":{const n=Je(r)
Ye(this,e,(e=>e.unshift(...n)),"Cannot unshift duplicates to a hasMany's state.")
{const n=new Set(e),o=new Set
r.forEach((e=>{const t=Y(e)
n.has(t)||(n.add(t),o.add(e))}))
const a=Array.from(o),l=Reflect.apply(e[i],t,a)
return a.length&&Ze(this,{value:Je(a),index:0},s),l}}case"shift":{const n=Reflect.apply(e[i],t,r)
return n&&Qe(this,{value:Y(n),index:0},s),n}case"sort":{const n=Reflect.apply(e[i],t,r)
return function(e,t,i){et(e,{op:"sortRelatedRecords",record:e.identifier,field:e.key,value:t},i)}(this,n.map(Y),s),n}case"splice":{const[n,o,...a]=r
if(0===n&&o===this[pe].length){const r=Je(a)
Ye(this,e,(e=>e.splice(n,o,...r)),"Cannot replace a hasMany's state with a new state that contains duplicates.")
{const r=new Set(a),l=Array.from(r),c=[n,o].concat(l),d=Reflect.apply(e[i],t,c)
return Xe(this,Je(l),s),d}}const l=Je(a)
Ye(this,e,(e=>e.splice(n,o,...l)),"Cannot splice a hasMany's state with a new state that contains duplicates.")
{const r=e.slice()
r.splice(n,o)
const l=new Set(r),c=[]
...
return o>0&&Qe(this,{value:h.map(Y),index:n},s),c.length>0&&Ze(this,{value:Je(c),index:n},s),h}}}}notify(){this[fe].shouldReset=!0,_e(this)}reload(e){return this._manager.reloadHasMany(this.key,e)}createRecord(e){const{store:t}=this,i=t.createRecord(this.modelName,e)
return this.push(i),i}destroy(){super.destroy(!1)}}function Je(e){return e.map(Ge)}function Ge(e){return Y(e)}function Ye(e,t,i,s){const n=t.slice()
if(i(n),n.length!==new Set(n).size){const t=n.filter(((e,t)=>n.indexOf(e)!==t));(0,r.deprecate)(`${s} This behavior is deprecated. Found duplicates for the following records within the new state provided to \`<${e.identifier.type}:${e.identifier.id||e.identifier.lid}>.${e.key}\`\n\t- ${Array.from(new Set(t)).map((e=>S(e)?e.lid:Y(e).lid)).sort(((e,t)=>e.localeCompare(t))).join("\n\t- ")}`,!1,{id:"ember-data:deprecate-many-array-duplicates",for:"ember-data",until:"6.0",since:{enabled:"5.3",available:"4.13"}})}}function Ze(e,t,i){et(e,{op:"add",record:e.identifier,field:e.key,...t},i)}function Qe(e,t,i){et(e,{op:"remove",record:e.identifier,field:e.key,...t},i)}function Xe(e,t,i){et(e,{op:"replaceRelatedRecords",record:e.identifier,field:e.key,value:t},i)}function et(e,t,i){e._manager.mutate(t),(0,l.RH)(i)}Ke.prototype.isAsync=!1,Ke.prototype.isPolymorphic=!1,Ke.prototype.identifier=null,Ke.prototype.cache=null,Ke.prototype._inverseIsAsync=!1,Ke.prototype.key="",Ke.prototype.DEPRECATED_CLASS_NAME="ManyArray"},113:(e,t,i)=>{"use strict"
...
i&&(i.shouldReset=!0,d(i))}},193:(e,t,i)=>{"use strict"
function r(e){return e?.__esModule?e:{default:e,...e}}i.d(t,{A:()=>r})},241:(e,t,i)=>{"use strict"
...
return t&&t.default&&(t=t.default),t}}function _(e,t){if(!t)throw new Error(e)}y(g,"moduleBasedResolver",!0)},648:(e,t,i)=>{"use strict"
...
i.d(t,{k5:()=>n,pm:()=>s})
var r=i(375)
const s=(0,r.L1)("Store",Symbol("Store")),n=(0,r.L1)("$type",Symbol("$type"));(0,r.L1)("RequestSignature",Symbol("RequestSignature"))},805:(e,t,i)=>{"use strict"
...
let i=z.get(t)
return i||(i=new L(t),z.set(t,i),l(t)._graph=i),i}function G(e){return e instanceof Error}i(842),new Map
...
return n&&Ae(o,n),o}static create(e){return new this(e)}}globalThis.setWarpDriveLogging=me.q,globalThis.getWarpDriveRuntimeConfig=me.P
var ze=i(193)
...
const o=(0,ze.A)(r).graphFor,{identifier:a}=this,l=o(this._store).getData(a,e),c=l&&l.data,d=c?n.identifierCache.getOrCreateRecordIdentifier(c):null
...
const a=this._store,l=(a.schema.fields({type:this.modelName}).get(e),(0,ze.A)(r).graphFor),{identifier:c}=this,d=l(this._store).getData(c,e)
...
if(!i){const i=(0,(0,ze.A)(r).graphFor)(d)
...
if(!e._fetchManager){const t=(0,ze.A)(s).FetchManager
...
var o=i[n.index]
a(l(r(e,o.loc.start.offset,o.loc.end.offset),t.source,o.loc.start.line,o.loc.start.column),e,t.source,o.loc.start.line,o.loc.start.column)}},e.exports=t()}}])
